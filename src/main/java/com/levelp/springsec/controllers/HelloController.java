...
public class HelloController {
    ...
    public String delete() { // int accountId
        ...
        Session session = factory.openSession();
        Account account = session.createQuery("from Account where id = 6", Account.class)
                .uniqueResult();

        MutationQuery query = session.createMutationQuery("delete Bill where id >= 7 and id <= 9");
